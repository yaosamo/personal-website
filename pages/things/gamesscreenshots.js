...
function renderImages() {
  //acess to images in folder ..images
}
...
export default function GamesScreenshots() {
  ...
  <Head>
      ...
      <div className="header">
        <h1 className="title">Games Screenshots</h1>
        <p className="subtitle">Over 1500 screenshots of official releases.</p>
      </div>
      </div>
      ...
      <div className="content">
        <div className="__screenshots">
          ...
          <img src="../images/games/gameboy/3 Choume no Tama - Tama and Friends - 3 Choume Obake Panic!! (Japan).png"/>
      {/* { images.map(image => <img src={images['doggy.png']} />) } */}
