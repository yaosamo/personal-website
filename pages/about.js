      ...
      <div className="content">
        <div className="item">
          <div className="timestamp">
            <p>October 3, 2021 at 9:43 PM</p>
            <div className="cursor" />
          </div>
          <p className="subtitle">
            Hi, I’m Yaroslav Samoylov, a Lead Product Designer working on tools
            for dealerships at{" "}
            <a
              className="url"
              href="https://gubagoo.com/"
              target="_blank"
              alt="Gubagoo"
            >
              Gubagoo
            </a>
            . With Gubagoo I collaborated with teams at Facebook, Apple Business
            Chat, Google Business and many more. Our clients include BMW,
            Toyota, Mercedes, Volvo, Porsche and pretty much every big
          ...
          <p className="subtitle">
            ...
            <a
              className="url"
              href="https://earth.google.com/web/search/Togliatti,+Russia/@53.5218785,49.4863315,94.73430165a,44273.45089792d,35y,0h,0t,0r/data=CnsaURJLCiQweDQxNjg3OGU4MDBjY2NlMTU6MHhmNTU2OTI3YjEwZDA5NmEZZRniWBfBSkAh6kVIOIi1SEAqEVRvZ2xpYXR0aSwgUnVzc2lhGAIgASImCiQJrabEskZFOkARrabEskZFOsAZbxKR1dymR0AhEIPO37PqTsA"
              target="_blank"
              alt="Togliatti on Google Earth"
            >
              Togliatti, Russia
            </a>
            . Living in lovely Hillsboro,{" "}
            <a
              className="url"
              href="https://www.instagram.com/p/CTYrHeGL70g/"
              target="_blank"
              alt="Oregon, Instagram photo"
            >
              Oregon
            </a>
            . I’m an O1 visa holder and currently working on the green card.
            Married to a beautiful woman and we have almost 3 years old
            dragon-blood son.
          </p>
          <p className="subtitle">
            I love how through design you can change people’s preconceived
            notion about well-established processes and open new possibilities.
            I’ve always been inspired by the tech industry to explore and
            create. In my spare time I enjoy adjacent areas to design such as
            3D, coding, art and game development.
          </p>
          <p className="subtitle">
            Also I play ultimate frisbee and support{" "}
            <a
              className="url"
              href="https://duckduckgo.com/?q=arsenal+fc&va=b&t=hc&ia=web"
              target="_blank"
            >
              Arsenal FC
            </a>
        ...
        <div className="item-2">
          ...
          <p className="block-end">
            This is me working on this page, while listening{" "}
            <a
              className="url"
              href="https://open.spotify.com/playlist/37i9dQZF1DXaWgNWdGsjlE?si=555a4c2f75974958"
              target="_blank"
              alt="Sludge Playlist on Spotify"
            >
              Sludge
            </a>{" "}
            playlist and watching Silicon Valley on the background
          </p>
          ...
          <ul>
            ...
            <li>
              <a
                className="url"
                href="https://www.amazon.com/ZINGYOU-Microphone-BM-800-Double-layer-Broadcasting/dp/B0756V2B6R/ref=asc_df_B0756V2B6R/?tag=hyprod-20&linkCode=df0&hvadid=312155612850&hvpos=&hvnetw=g&hvrand=7241119365179716924&hvpone=&hvptwo=&hvqmt=&hvdev=c&hvdvcmdl=&hvlocint=&hvlocphy=9032905&hvtargid=pla-563974502298&psc=1"
                target="_blank"
                alt="Microphone: Amazon Link"
              >
                Microphone
              </a>
            </li>
          ...
          <ul>
            ...
            <li>
              <a
                ...
                target="_blank"
                alt="Bellroy, Wallets & Accessories"
              >
                Bellroy
              </a>
            </li>
            <li>
              <a
                ...
                target="_blank"
                alt="Airbirds, my favorite shoes"
              >
                Airbirds
              </a>
            </li>
            <li>
              <a
                className="url"
                href="https://sputnik-bags.ru"
                target="_blank"
                alt="Bags from my home town"
              >
                Sputnik bags
              </a>
            </li>
            <li>
              <a
                className="url"
                href="http://Shwoodshop.com"
                target="_blank"
                alt="Portland, Oregon based wood glasses"
              >
                Shwood Eyewear
              </a>
            </li>
        ...
        <div className="item">
          ...
          <ul>
            <li>
              ...
              <a
                className="url"
                href="http://dribbble.com/yaosamo"
                target="_blank"
                alt="Dribbble"
              >
                @yaosamo
            ...
            <li>
              ...
              <a
                className="url"
                href="https://instagram.com/yaosamo"
                target="_blank"
                alt="Instagram"
              >
                @yaosamo
            ...
            <li>
              ...
              <a
                className="url"
                href="https://open.spotify.com/user/yaosamo"
                target="_blank"
                alt="Spotify"
              >
                @yaosamo
